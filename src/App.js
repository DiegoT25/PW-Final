import { CreateAccountPage, LoginPage, MenuPrincipalPage, ProfileInfoPage, ProductoBusquedaPage, CarritoComprasPage,
  ...
  ReviewsPage, SubmitRequestPage,GamePage, Historia23Page, InfluencersPage, RankingOrdenadoresPage,} from './components/pages'
    ...
    <>
      <BrowserRouter>
        <Routes>
            ...
            <Route path="/historia24" element={<RankingOrdenadoresPage />}/>
